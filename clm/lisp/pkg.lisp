...
;;(setq *sccsid* "@(#)pkg.lisp	1.11 9/21/93")

(in-package :user)

#+(or :allegro-v4.0 (and excl (version>= 4 1)) :lcl4.0 :genera :lispworks)
(defpackage :xtk
  #-(or lucid genera excl) (:use :common-lisp)
  #+excl (:use :common-lisp :cltl1) ;; :mp ??
  #+genera (:use :future-common-lisp)
  #+lucid (:use :lisp :lcl)
...
#-(or :allegro-v4.0 (and excl (version>= 4 1)) :genera :lcl4.0 :lispworks)
(in-package :xtk)

#-(or :allegro-v4.0 (and excl (version>= 4 1)) :genera :lcl4.0 :lispworks)
(use-package '(:lisp #+excl :mp))
